...
audiochannel_manager = {
    #aAudio Channel list
	"default_audiochannel":{},
}
colour_manager = {
...
default_effect_opts = {"Energy":    {"blur": 1,                       # Amount of blur to apply
                       ...
                       "Scroll":    {"channel_audio": "Mono",         # Audio channel from mic
...
dynamic_effects_config = {"Energy":[#["color_mode", "Audio Channel", "dropdown", "gradients"],
                            ...
                            "Wave":[["color_flash", "Audio Channel", "dropdown", "colours"],
									["color_flash", "Flash Color", "dropdown", "colours"],
                        ...
                        "Spectrum":[#["Audio_channel", "Audio Channel", "dropdown", "gradients"],
									["r_multiplier", "Red", "float_slider", (0.05,1.0,0.05)],
                                    ["g_multiplier", "Green", "float_slider", (0.05,1.0,0.05)],
                                    ["b_multiplier", "Blue", "float_slider", (0.05,1.0,0.05)]],
                      "Wavelength":[["color_mode", "Audio Channel", "dropdown", "gradients"],
                          ...
                          "Scroll":[["channel_audio", "Audio Channel", "dropdown", "colours"],
									["lows_color", "Lows Color", "dropdown", "colours"],
                           ...
                           "Power":[["color_mode", "Audio Channel", "dropdown", "gradients"],
									["color_mode", "Color Mode", "dropdown", "gradients"],
                          ...
                          "Single":[["color", "Color", "dropdown", "colours"]],
                            "Beat":[["color", "Audio Channel", "dropdown", "colours"],
									["color", "Color", "dropdown", "colours"],
                                    ["decay", "Flash Decay", "float_slider", (0.3,0.98,0.005)]],
                            "Bars":[["color_mode", "Audio Channel", "dropdown", "gradients"],
									["color_mode", "Color Mode", "dropdown", "gradients"],
...
audiochannels = {"Mono":(255,0,0),
                   "Stereo - In development":(255,255,0),
                   "Left - In development":(255,40,0),
                   "Right - In development":(255,70,0),}
#
# plz ignore
