...
class Visualizer(BoardManager):
    ...
    def visualize_scroll(self, y):
		...
		#Audio Channel
        mids_val = (np.array(colour_manager.colour(config.settings["devices"][self.board]["effect_opts"]["Scroll"]["channel_audio"])) * mids_max).astype(int)		
...
class AudioChannelManager():
    """
    Audio channels that can be defined: Mono, Stereo, Left, Right
    """
    def channel_audio(self, channel_audio):
